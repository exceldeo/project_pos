             ...
             <div class="row">
              ...
              <div class="col-lg-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="pelanggan" required="required" placeholder="Masukkan Nama Pelanggan .. (Wajib)" value="-">
                </div>
                                  ...
                                  <tr>
                                    ...
                                    <td width="1%">              
                                      ...
                                      if($d['produk_stok'] > 0){
                                        ...
                                        <input type="hidden" id="stok_<?php echo $d['produk_id']; ?>" value="<?php echo $d['produk_stok']; ?>" >
